...
/**
  * This interface defines all the commands that the Jacksontest aggregate supports.
 * <p>
 ...
 */
public interface JacksontestCommand extends Jsonable {
    /**
    ...
    @Value
    @JsonDeserialize
    final class UseGreetingMessage implements JacksontestCommand, CompressedJsonable {
    ...
    @Value
    @JsonDeserialize
    final class Hello implements JacksontestCommand {
